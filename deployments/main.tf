resource "aws_instance" "test-server" {
  ...
  key_name = "anji"
  vpc_security_group_ids= ["sg-081873e1716b7a059"]
  connection {
    type     = "ssh"
    user     = "ubuntu"
    private_key = file("./anji.pem")
    host     = self.public_ip
  }
	...
	inline = [
        "sudo apt update -y",
             ...
             # "sudo microk8s enable dns ingress",
              ...
              "sudo microk8s kubectl create deployment health-deploy --image=554716/newhealthcare:latest",
